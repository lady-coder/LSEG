...
# Check repo config in sagemaker notebook with this command 'pip config -v list'

# The URL of your repository
PYPI_URL=https://nexus.lseg.stockex.local/
...
[global]
index-url = https://nexus.lseg.stockex.local/repository/PyPI-Proxy/simple
