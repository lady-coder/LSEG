module "boxi_client" {
  ...
  count = var.boxi_environment_name.client
  ...
  subnet_id                            = contains(var.az_subnet_override, count.index+1) ? var.subnet_2c : (count.index % 2 != 0 ? var.subnet_2a : var.subnet_2b) // odd in 2a even in 2b - look at mod function */
  ...
  user_data_base64     = base64encode(data.template_file.userdata_client.rendered)
...
//   instance_id = module.boxi_client[count.index].id
// }
